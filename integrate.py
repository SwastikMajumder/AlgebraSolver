...
#eq = string_to_equation_short("(inf(int((-1*((a^2)^-1)*(o^2)*dif(o))))+(inf(m)*inf((n^-1)))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o)))")
#eq = string_to_equation_short("(inf(int((n*o*-1*1*((a^2)^-1)*dif(o)*(n^-1)*((o^-1)^-1)*1)))+(inf(m)*inf((n^-1)))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o)))")
#eq = string_to_equation_short("(inf(int((-1*o*n*1*((a^2)^-1)*dif(o)*(n^-1)*((o^-1)^-1))))+(inf(dif(n))*inf((1*((a^2)^-1)*dif(o)*(n^-1)*((o^-1)^-1))))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((-1*o*n*dif(o)*(((2^-1)*(o^-1)*(a^2)*2*n)^-1))))+(inf(dif(n))*inf((dif(o)*(((2^-1)*(o^-1)*(a^2)*2*n)^-1))))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((dif(n)*-1*o*n)))+(inf(((2^-1)*(o^-1)*(a^2)*2*n*dif(n)))*inf(dif(o)))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((dif(n)*-1*o*n)))+(inf(dif(o))*inf(((2^-1)*(o^-1)*dif(((a^2)*(n^2))))))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((dif(n)*-1*o*n)))+(inf(((2^-1)*((((n^2)*(a^2))+-1)^((2^-1)+-1))*dif((((n^2)*(a^2))+-1))))*inf(dif(o)))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((dif(n)*-1*o*n)))+(inf(dif(((((n^2)*(a^2))+-1)^(2^-1))))*inf(dif(o)))+(inf(((((n^2)*(a^2))+-1)^(2^-1)))*inf(o))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int((dif(n)*-1*((((n^2)*(a^2))+-1)^(2^-1))*n)))+(inf(m)*inf((n^-1))))")
#eq = string_to_equation_short("(inf(int(((((a^2)+(-1*((n^-1)^2)))^(2^-1))*(n^4)*-1*(n^-2)*dif(n))))+(inf(m)*inf((n^-1)))+(inf(dif(m))*inf((-1*(n^-2)*dif(n)))))")
#eq = string_to_equation_short("inf(int((a^2-m^2)^(2^-1)*m^-4*dif(m)))")
#eq = string_to_equation_short("(inf(int(((((a^2)+(-1*(m^2)))^(2^-1))*((m^-1)^4)*dif(m))))+(inf(dif(m))*inf(((-1^-1)*dif(n)*((m^-2)^-1))))+(inf(n)*inf((m^-1))))")
while True:
